const StorageCtrl = (function Storage(){
    ...
    return{
        ...
        storeInLs: function(item) { // item is an object, not an array
            let task;
            ...
            task.push(item); // ✅ push single object
    ...
    return {
        ...
        getNewItem : function(newItems){
            ...
            newItems.forEach(function(item){
                newList = new Item(ID,item.name,item.money)
...
const AppCtrl = (function App(){
    ...
    const addFunction = function(){
       ...
       ItemCtrl.getNewItem(addedItems);
       StorageCtrl.storeInLs(addedItems);
    ...
    const editFunction = function(e){
        const getCurrentItems = ItemCtrl.getItems();
